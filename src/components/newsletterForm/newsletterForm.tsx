                ...
                <form action="https://xyz.us15.list-manage.com/subscribe/post?u=03287c1370c469c08fd6ae8c2&amp;id=c43332b02e" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" className="validate" target="_blank" noValidate>
                    <div id="mc_embed_signup_scroll">                
                        <div className="mc-field-group">
                            ...
                            <input type="email" defaultValue="" name="EMAIL" placeholder="Enter your email..." className="required email" id="mce-EMAIL" />
                        </div>
                        ...
                        <div style={{ position: "absolute", left: "-5000px"}} aria-hidden="true">
                            <input type="text" name="b_03287c1370c469c08fd6ae8c2_c43332b02e" tabIndex={-1} defaultValue="" />
                        </div>
                        <div className="clear">
                            <button type="submit" name="subscribe" id="mc-embedded-subscribe">{language.newsletter.submitButton}</button>
                        </div>
                    </div>
                </form>
            </Cell>
